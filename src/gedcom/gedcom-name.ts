...
/**
 * Fold a GEDCOM name suffix (NSFX, e.g. "Jr.", "Sr.", "III") into the display
 * name (#685). GEDCOM keeps the generational suffix in a separate NSFX tag, so
 * relatives who share a given name and surname otherwise resolve to the same
 * note name and get numeric-deduplicated (`John Smith`, `John Smith 1`,
 * `John Smith 2`) instead of keeping their suffix. Appending it keeps them
 * distinct in both the note name and the filename.
 *
