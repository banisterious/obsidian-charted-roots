...
export type DynamicBlockType = 'canvas-roots-timeline' | 'canvas-roots-relationships' | 'canvas-roots-media' | 'charted-roots-source-roles' | 'charted-roots-transfers' | 'charted-roots-members';
