...
**Pending port (next session):** the **v0.22.74**, **v0.22.75**, and **v0.22.76 Round-Up** spotlights (all drafted below) plus the cluster-intro updates that accompany them — release count seventy-four → seventy-seven, test count 1569 / v0.22.73 → 1642 / v0.22.76, the new v0.22.74 / v0.22.75 / v0.22.76 narrative sentences, and the scanner-streak extension through v0.22.76's clean post-release scan. Standing **verify-before-publish** reminders: the stability-window anchor (still v0.22.59, no resets through v0.22.76) and the scanner-streak prose against the #411 tracking.
