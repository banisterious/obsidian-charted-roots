...
**Pending port (next session):** v0.22.58 through v0.22.68 Round-Up spotlights AND the cluster-intro extension (release count to sixty-eight, tests to 1420 at v0.22.68, per-release clauses for v0.22.62-68, and the scanner-streak sentence carried through v0.22.66, which held at the 96 / 100 baseline with a clean post-release scan) are all drafted below and ready for the chartedroots.com port. chartedroots.com `/changelog/` is current through v0.22.57. **Verify before publish:** the stability-window anchor (drafted as still v0.22.59, no resets through v0.22.65) and the scanner-streak prose against the #411 tracking. The v0.22.61 scan's findings (an ESLint directive error and Obsidian 1.13 API deprecations) were cleared in v0.22.62, v0.22.64's scan surfaced one no-unsafe-assignment warning cleared in v0.22.65, and v0.22.65's post-release Community scan came back clean.
...
**[Read the full release notes ->](https://github.com/banisterious/obsidian-charted-roots/wiki/Release-History#v02268-round-up-organizations-come-to-parity-deeper-timeline-place-context-and-name-affixes-v02268)**
...
**[Read the full release notes ->](https://github.com/banisterious/obsidian-charted-roots/wiki/Release-History#v02267-round-up-highlight-dimming-custom-relationship-labels-and-a-full-type-check-pass-v02267)**
