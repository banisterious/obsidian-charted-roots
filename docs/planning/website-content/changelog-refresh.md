...
**Pending port (next session):** v0.22.53 Round-Up spotlight + cluster-intro metric bumps to fifty-four releases / 1060 tests / seventh patch in the v0.22.46-anchored window.
