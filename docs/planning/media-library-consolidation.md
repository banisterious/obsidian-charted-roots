...
**Status:** 🔶 In progress. **Phases 1, 2, and 4 all shipped 2026-05-01.** The README curation refresh (commit `e7bc00a6`) retired seven legacy README captures and obviated three of the four originally-Phase-3 re-captures by dropping those features from the README. Phase 1 (buy-me-a-coffee relocation) and Phase 4 (collapsing `raw/` up to `docs/images/`) followed in the same session. Only the reduced Phase 3 (Statistics — wiki-only) remains.
**Authored:** 2026-04-27.
