...
- `npm test` - Run the Vitest regression suite once (1420 tests across 122 suites as of v0.22.68, covering pure helpers for relationships, migrations, the sibling walker, event identity, date handling, and a large set of issue-specific regression suites)
