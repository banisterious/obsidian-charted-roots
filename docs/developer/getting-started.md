...
- `npm test` - Run the Vitest regression suite once (1493 tests across 129 suites as of v0.22.70, covering pure helpers for relationships, migrations, the sibling walker, event identity, date handling, and a large set of issue-specific regression suites)
